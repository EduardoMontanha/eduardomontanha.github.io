...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.en = {
            description: 'Usamos cookies para oferecer a você uma melhor experiência de navegação, personalizar conteúdo e anúncios, fornecer recursos de mídia social e analisar nosso tráfego. Leia sobre como usamos cookies e como você pode controlá-los clicando em Configurações de cookies. Você concorda com os nossos cookies se continuar a usar este site.',
            ...
            cookie_essential_desc: 'Os cookies necessários ajudam a tornar um site utilizável, permitindo funções básicas como navegação de página e acesso a áreas seguras do site. O site não pode funcionar corretamente sem esses cookies.',
            cookie_performance_title: 'Cookies de desempenho',
            cookie_performance_desc: 'Esses cookies são usados para melhorar o desempenho e a funcionalidade de nossos sites, mas não são essenciais para seu uso. Por exemplo, ele armazena seu idioma preferido ou a região em que você está.',
            cookie_analytics_title: 'Cookies analíticos',
            cookie_analytics_desc: 'Usamos cookies analíticos para nos ajudar a medir como os usuários interagem com o conteúdo do site, o que nos ajuda a personalizar nossos sites e aplicativos para você, a fim de melhorar sua experiência.',
            cookie_marketing_title: 'Cookies de marketing',
            cookie_marketing_desc: 'Esses cookies são usados para tornar as mensagens publicitárias mais relevantes para você e seus interesses. A intenção é exibir anúncios que sejam relevantes e envolventes para o usuário individual e, portanto, mais valiosos para editores e anunciantes terceiros.'
        }
